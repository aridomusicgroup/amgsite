...
export const DOT_ACTIVIDAD: Record<string, string> = {
  ...
  musico_asignado: "bg-white/50",
  musico_archivo: "bg-blue-400",
  musico_archivo_retirado: "bg-white/30",
  ...
  cobranza_enviada: "bg-amber-400",
  drive_caido: "bg-red-400",
  recompra_enviada: "bg-green-400",
  curso_acceso_dado: "bg-green-400",
  curso_acceso_renovado: "bg-blue-400",
  curso_acceso_quitado: "bg-white/30",
